...
class SingleItemAccessories extends StatefulWidget {
  final List<String> itemDetails;

  const SingleItemAccessories({Key? key, required this.itemDetails}) : super(key: key);

  @override
  State<SingleItemAccessories> createState() => _SingleItemState();
}

class _SingleItemState extends State<SingleItemAccessories> {
  int itemCount = 1;
